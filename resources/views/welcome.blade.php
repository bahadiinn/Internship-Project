	...
	<div id="container">
		...
		<section id="home-section" class="slider1">
			...
			<div class="tp-banner-container">
				...
				<div class="tp-banner" >
					<ul>	<!-- SLIDE  -->
						<li data-transition="fade" data-slotamount="4" 3 data-saveperformance="on"  data-title="Intro Slide">
							<!-- MAIN IMAGE -->
							<img src="images/slide1.png"  alt="slidebg1" >
							<!-- LAYERS -->
						...
						<li data-transition="fade" data-slotamount="4" 3 data-saveperformance="on"  data-title="Intro Slide">
							<!-- MAIN IMAGE -->
							<img src="images/slide2.png"  alt="slidebg1" >
							<!-- LAYERS -->
						...
						<!-- SLIDE  -->
						<li data-transition="fade" data-slotamount="4" data-masterspeed="300" data-saveperformance="on"  data-title="Intro Slide">
							<!-- MAIN IMAGE -->
							<img src="images/slide3.png" peat">
							<!-- LAYERS -->
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        @if (Route::has('login'))
						   ...
						   <li><a href="#home-section"> Logout</a></li>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="image-holder">
								...
								<img class="snd-img" src="images/history2.jpg" alt="">
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="image-holder">
								...
								<img class="snd-img" src="images/resto2.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="today-special-box">
					...
					<div class="food-line">
						...
						<div class="food-post">
							<div class="inner-food-post">
								<div class="food-gal">
									<img src="images/chocolat.jpg" alt="">
								</div>
								<div class="food-content">
									<div class="food-content-box">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<form class="reservation-form" method="post">
								...
								<label>Date:</label>
								<input type="date" name="date-guest" id="date-guest" placeholder="mm/dd/yyyy"/>
								<div class="row">
									<div class="col-md-6">
										<label>Time:</label>
		...
		<section id="gallery-section">
			...
			<div class="gallery-box iso-call">
				...
				<div class="gal-project rest">
					<img src="images/restor1.jpg" alt="">
					<div class="hover-gal">
						<div class="inner-gal">
							<h2>Aliquam tincidunt</h2>
				...
				<div class="gal-project rest">
					<img src="images/restor2.jpg" alt="">
					<div class="hover-gal">
						<div class="inner-gal">
							<h2>Aliquam tincidunt</h2>
							<span>Restaurant</span>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="info-widget">
									...
									<p> 852/524 Street  Zarrouk , Gafsa <br> Tunisia </p>
									<p>
		...
		<footer>
			<p class="copyright">
				&copy; 2022 Baha Eddin Elhaj : IT student <br> A big thanks to Firas Boukhris ,CEO of Make It Happen
			</p>
		</footer>
		<!-- End footer -->
